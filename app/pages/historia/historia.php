                        ...
                        <tr>
                            <td>
                                <div class="d-flex justify-content-center">
                                    <!-- view -->
                                    <button type="button" class="btn btnHView" data-toggle="modal" data-target="#iframeModal" data-btnView="<?= $hid ?>" data-stafiID="<?= $sid ?>" data-backdrop="static" data-keyboard="false">
