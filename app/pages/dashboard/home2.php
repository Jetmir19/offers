...
<div class="container-fluid mb-3 pb-5">
    ...
    <div class="pt-3 pb-2 mb-3 d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center border-bottom">
        <h2>Mirë se vini<strong class="text-muted"> Përdorues </strong></h2>
            ...
            <div class="d-flex flex-wrap border">
                ...
                <div class="bg-white p-3">
                    ...
                    <h3 class="font-weight-bold mb-0">
                        <?php
                        $sql = mysqli_query($link, "SELECT * FROM konsumatoret WHERE stafiID = '$stafiID' AND isDeleted = 0");
                ...
                <div class="bg-white p-3">
                    <p class="font-weight-bold mb-0">Aktiv -
                        <?php
                        $sql = mysqli_query($link, "SELECT * FROM konsumatoret WHERE stafiID = '$stafiID' AND kostatusi = 'aktiv' AND isDeleted = 0");
                        $num_rows = mysqli_num_rows($sql);
                        echo "$num_rows";
                        ?>
                    </p>
                    <p class="font-weight-bold mb-0">Inaktiv -
                        <?php
                        $sql = mysqli_query($link, "SELECT * FROM konsumatoret WHERE stafiID = '$stafiID' AND kostatusi = 'inaktiv' AND isDeleted = 0");
                        $num_rows = mysqli_num_rows($sql);
                        echo "$num_rows";
                        ?>
                    </p>
        ...
        <div class="col-md-6 mb-3">
            <div class="d-flex flex-wrap border">
                ...
                <div class="bg-white p-3">
                    ...
                    <h3 class="font-weight-bold mb-0">
                        <?php
                        $sql = mysqli_query($link, "SELECT * FROM matesi WHERE stafiID = '$stafiID' AND isDeleted = 0");
                        $num_rows = mysqli_num_rows($sql);
                        echo "$num_rows \n";
                        ?>
                    </h3>
                ...
                <div class="bg-white p-3">
                    <p class="font-weight-bold mb-0">Aktiv -
                        <?php
                        $sql = mysqli_query($link, "SELECT * FROM matesi WHERE stafiID = '$stafiID' AND mastatusi = 'aktiv' AND isDeleted = 0 ");
                        $num_rows = mysqli_num_rows($sql);
                        echo "$num_rows";
                        ?>
                    </p>
                    ...
                    <p class="font-weight-bold mb-0">Inaktiv -
                        <?php
                        $sql = mysqli_query($link, "SELECT * FROM matesi WHERE stafiID = '$stafiID' AND mastatusi = 'inaktiv' AND isDeleted = 0 ");
                        $num_rows = mysqli_num_rows($sql);
                        echo "$num_rows";
                        ?>
                    </p>
        ...
        <div class="col-md-6 mb-3">
            <div class="d-flex flex-wrap border">
                ...
                <div class="bg-white p-3">
                    ...
                    <h3 class="font-weight-bold mb-0">
                        <?php
                        $sql = mysqli_query($link, "SELECT * FROM leximi WHERE stafiID = '$stafiID' AND isDeleted = 0");
                        $num_rows = mysqli_num_rows($sql);
                        echo "$num_rows \n";
                        ?>
                    </h3>
                ...
                <div class="bg-white p-3">
                    <p class="font-weight-bold mb-0">Të paguara -
                        <?php
                        $sql = mysqli_query($link, "SELECT * FROM leximi WHERE stafiID = '$stafiID' AND lestatusi = 'paguar' AND isDeleted = 0 ");
                        $num_rows = mysqli_num_rows($sql);
                        echo "$num_rows";
                        ?>
                    </p>
                    ...
                    <p class="font-weight-bold mb-0">Pa paguara -
                        <?php
                        $sql = mysqli_query($link, "SELECT * FROM leximi WHERE stafiID = '$stafiID' AND lestatusi = 'pa paguar' AND isDeleted = 0 ");
                        $num_rows = mysqli_num_rows($sql);
                        echo "$num_rows";
                        ?>
                    </p>
        ...
        <div class="col-md-6 mb-3">
            <div class="d-flex flex-wrap border">
                ...
                <div class="bg-white p-3">
                    ...
                    <h3 class="font-weight-bold mb-0">
                        <?php
                        $sql = mysqli_query($link, "SELECT * FROM fatura_leximi WHERE stafiID = '$stafiID' AND isDeleted = 0");
                        $num_rows = mysqli_num_rows($sql);
                        echo "$num_rows \n";
                        ?>
                    </h3>
    ...
    <section class="row mt-4">
        ...
        <div class="col-md-4 mb-3">
            <div class="text-center p-3 border shadow-sm">
                ...
                <p class="text-muted">
                    <?php
                    $sql = "SELECT SUM(gjithsej_kubik) AS gjithsej_kubik FROM fatura_leximi WHERE stafiID = '$stafiID' AND isDeleted = 0";
        ...
        <div class="col-md-4 mb-3">
            <div class="text-center p-3 border shadow-sm">
                ...
                <p class="text-muted">
                    <?php
                    $sql = "SELECT SUM(gjithsej_pa_tvsh) AS gjithsej_pa_tvsh FROM fatura_leximi WHERE stafiID = '$stafiID' AND isDeleted = 0";
                    $result = $link->query($sql);
                    $row = $result->fetch_assoc();
        ...
        <div class="col-md-4 mb-3">
            <div class="text-center p-3 border shadow-sm">
                ...
                <p class="text-muted">
                    <?php
                    $sql = "SELECT SUM(gjithsej_e_tvsh) AS gjithsej_e_tvsh FROM fatura_leximi WHERE stafiID = '$stafiID' AND isDeleted = 0";
                    $result = $link->query($sql);
                    $row = $result->fetch_assoc();
                    echo "\n" . $row['gjithsej_e_tvsh'];
                    ?>
        ...
        <div class="col-md-4 mb-3">
            <div class="text-center p-3 border shadow-sm">
                ...
                <p class="text-muted">
                    <?php
                    $sql = "SELECT SUM(gjithsej_me_tvsh) AS gjithsej_me_tvsh FROM fatura_leximi WHERE stafiID = '$stafiID' AND isDeleted = 0";
                    $result = $link->query($sql);
                    $row = $result->fetch_assoc();
        ...
        <div class="col-md-4 mb-3">
            <div class="text-center p-3 border shadow-sm">
                ...
                <p class="text-muted">
                    <?php
                    $sql = "SELECT SUM(gjithsej_amnesti) AS gjithsej_amnesti FROM fatura_leximi WHERE stafiID = '$stafiID' AND isDeleted = 0";
                    $result = $link->query($sql);
                    $row = $result->fetch_assoc();
        ...
        <div class="col-md-4 mb-3">
            <div class="text-center p-3 border shadow-sm">
                ...
                <p class="text-muted">
                    <?php
                    $sql = "SELECT SUM(gjithsej_total) AS gjithsej_total FROM fatura_leximi WHERE stafiID = '$stafiID' AND isDeleted = 0";
                    $result = $link->query($sql);
                    $row = $result->fetch_assoc();
                    echo "\n" . $row['gjithsej_total'];
                    ?>
