...
(1198, 574, 1, 4, 21, 4, 1, '', 'col 20', 0, '1.00', '18.00', '3443.00', '3443.00', '619.74', '4062.74', '0.00', '0.00', 0, '0000-00-00', '0000-00-00');
...
CREATE TABLE `furnitoret` (
  ...
  `PersonKontakt` varchar(250) NOT NULL,
...
(121, 4, 'edit', 'konfigurime', 'Regjistruar me sukses.', 'success', '2023-05-21 13:29:46', '2023-05-21 11:29:46', 0),
...
(2, 128518224, 1, '', '', '', '2309980470023', 'Person fizik', '10', 'Ch', 'B', 'Tetovo', 'NMK', 'Zvicer', '12121211', '', '', 'aktiv', '2022-03-06 01:28:51', '2023-05-19 20:12:39', 0),
...
CREATE TABLE `oferte_fature` (
  ...
  `statusi` varchar(50) DEFAULT 'pa paguar',
  `isDeleted` int(11) NOT NULL DEFAULT 0,
  `dateUpdated` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_swedish_ci;
...
(574, 1, 4, '190520236470', '3453443534534', '1.00', '3443.00', '619.74', '4062.74', '0.00', '0.00', '', 'pa paguar', 0, '0000-00-00');
...
CREATE TABLE `sherbimetpagesat` (
  ...
  `emriSherbimit` varchar(250) NOT NULL,
  `pershkrimiSherbimit` text NOT NULL,
...
--
ALTER TABLE `artikujt_per_oferte_fature`
  MODIFY `artikujt_perofert_fature_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1199;

--
-- AUTO_INCREMENT for table `cart`
--
ALTER TABLE `cart`
  MODIFY `cart_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2056;
...
--
ALTER TABLE `historia`
  MODIFY `historiaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
...
--
ALTER TABLE `oferte_fature`
  MODIFY `ofertatID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=575;
